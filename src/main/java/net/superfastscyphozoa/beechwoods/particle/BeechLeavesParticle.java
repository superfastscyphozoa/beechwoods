package net.superfastscyphozoa.beechwoods.particle;
...
public class BeechLeavesParticle extends SpriteBillboardParticle {
    private float field_43369;
    private final float field_43370;
    private final float field_43371;

    public BeechLeavesParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        ...
        float f = this.random.nextBoolean() ? 0.07F : 0.08F;
        this.scale = f;
